...
import rangvikalpsample.rangvikalp.generated.resources.Res
import rangvikalpsample.rangvikalp.generated.resources.ic_color
...
internal fun RowScope.ColorDots(
    ...
    dotDescription: String = "Color Dot",
    clickedColor: (Color) -> Unit,
) {
    ...
    IconButton(
        ...
        Icon(
            painterResource(Res.drawable.ic_color),
